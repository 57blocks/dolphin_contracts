...
contract PriceTest is Test {
    ...
    PriceModelSingle public priceModel;
    address ipId;
    ...
    function setUp() public {
        ...
        priceModel = new PriceModelSingle();
    ...
    function test_getPrice_Success() public {
        ...
        int128 one = priceModel.FP_ONE();
        // int price = priceModel.curve(1);
        uint price = priceModel.curve(1);
